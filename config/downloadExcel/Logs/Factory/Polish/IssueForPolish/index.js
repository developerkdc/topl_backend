...
// export const createFactoryIssueForPolishExcel = async (newData, req, res,) => {
//   try {

//     const workbook = new exceljs.Workbook();
//     const worksheet = workbook.addWorksheet('Polish-Issue-Report');
...
//         is_polish_done: item.is_polish_done ? 'Yes' : 'No',
...
//     const fileName = `Polish_Issue_Report_${timestamp}.xlsx`;
...
export const createFactoryIssueForPolishExcel = async (newData, req, res) => {
  try {
    ...
    const ws = wb.addWorksheet('Polish‑Issue‑Report');
    ...
    ws.columns = [
      ...
      /* audit columns were already present */
    ...
    const fileName = `Polish_Issue_Report_${Date.now()}.xlsx`;
    res.setHeader(
