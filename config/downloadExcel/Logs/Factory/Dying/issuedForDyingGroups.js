...
const GenerateIssuedForDyingGroupsLogs = async (details) => {
  const workbook = new ExcelJS.Workbook();
  const worksheet = workbook.addWorksheet("Issued For Dying Groups Logs");
...
export { GenerateIssuedForDyingGroupsLogs };
