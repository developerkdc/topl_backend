...
export const createCrosscuttingDoneExcel = async (newData) => {
    try {
        ...
        newData?.forEach((data) => {
            try {
                const rowData = {
                    ...
                    crosscut_date: new Date(data?.worker_details?.crosscut_date).toLocaleDateString(),
        ...
        const filepath = "public/upload/reports/factory/crosscutting/crosscutting-done-report.xlsx";
