...
const GenerateIssuedForSmokingGroupsReport = async (details) => {
  ...
  const filePath =
    'public/reports/Group/IssuedForSmokingGroupsReportExcel/issue_for_smoking_groups_reports.xlsx';
  ...
  const destinationPath = `public/reports/Group/IssuedForSmokingGroupsReportExcel/${downloadFileName}`;
