...
const GenerateDyedGroupsReport = async (details) => {
  ...
  worksheet.columns = [
    ...
    { header: "Consumed Item Name", key: "consumed_item_name", width: 15 },
    ...
    {
      header: "GROUP Physical Location",
  ...
  const filePath = "public/reports/Dying/DyedGroupsReportExcel/dyed_groups_reports.xlsx";
