...
router.get("/core-item-listing-by-invoice/:invoice_id", core_item_listing_by_invoice);
router.patch("/edit-invoice-item-inventory/:invoice_id", edit_core_item_invoice_inventory);
