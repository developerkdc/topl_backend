...
import { fetch_all_mdf_pallet_no_item_name, fetch_mdf_details_by_id } from '../../../controllers/inventory/mdf/mdf_issue_for_order.controller.js';
...
router.get('/pallet-no-dropdown/:id', AuthMiddleware , fetch_all_mdf_pallet_no_item_name);
