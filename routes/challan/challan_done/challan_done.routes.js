...
import {
  ...
  listing_challan_done, update_inward_challan_status_by_challan_id, listing_single_challan
...
challan_done_router.get("/fetch-single-challan/:id", AuthMiddleware, listing_single_challan)
