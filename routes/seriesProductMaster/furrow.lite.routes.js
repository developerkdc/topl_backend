...
router.post('/add-furrow-lite', AuthMiddleware, MulterFunction(`public/upload/images/series_product_master/furrow_lite`).single('image'), addFurrowLite);
router.post('/update-furrow-lite/:id', AuthMiddleware, MulterFunction(`public/upload/images/series_product_master/furrow_lite`).single('image'), updateFurrowLiteDetails);
