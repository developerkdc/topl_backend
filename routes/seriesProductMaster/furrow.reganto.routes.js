...
router.post('/add-furrow-reganto', AuthMiddleware, MulterFunction(`public/upload/images/series_product_master/furrow_reganto`).single('image'), addFurrowReganto);
router.post('/update-furrow-reganto/:id', AuthMiddleware, MulterFunction(`public/upload/images/series_product_master/furrow_reganto`).single('image'), updateFurrowRegantoDetails);
