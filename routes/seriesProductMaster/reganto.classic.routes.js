...
router.post('/add-reganto-classic', AuthMiddleware, MulterFunction(`public/upload/images/series_product_master/reganto_classic`).single('image'), addRegantoClassic);
router.post(
  '/update-reganto-classic/:id',
  AuthMiddleware,
  MulterFunction(`public/upload/images/series_product_master/reganto_classic`).single('image'),
  updateRegantoClassicDetails
);
