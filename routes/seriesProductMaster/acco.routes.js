...
router.post('/add-acco', AuthMiddleware, MulterFunction(`public/upload/images/series_product_master/acco_master`).single('image'), addAcco);
router.post('/update-acco/:id', AuthMiddleware, MulterFunction(`public/upload/images/series_product_master/acco_master`).single('image'), updateAccoDetails);
