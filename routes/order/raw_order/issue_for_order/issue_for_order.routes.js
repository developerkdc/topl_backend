...
issue_for_raw_order_router.use("/issue-raw-log-order", log_inventory_order_router)
issue_for_raw_order_router.use("/issue-raw-flitch-order", flitch_inventory_order_router)
