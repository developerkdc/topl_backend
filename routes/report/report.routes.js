...
import {
  FinishingDoneReportExcel,
  IssuedForFinishingReportExcel,
} from '../../controllers/report/finishing.js';
import {
...
import {
  IssuedForTappingReportExcel,
  TappingDoneReportExcel,
} from '../../controllers/report/tapping.js';
import {
  IssuedForPressingReportExcel,
  PressingDoneReportExcel,
} from '../../controllers/report/pressing.js';
import {
...
import {
  CuttingDoneReportExcel,
  IssuedForCuttingReportExcel,
} from '../../controllers/report/cutting.js';
import {
...
router.post(
  '/download-excel-group-history-normal',
  GroupsHistoryNormalReportExcel
);
...
router.post(
  '/download-excel-issue-for-finishing',
  IssuedForFinishingReportExcel
);
