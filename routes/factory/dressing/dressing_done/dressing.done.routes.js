...
import {
  ...
  fetch_all_log_no_code_by_item_name,
  fetch_all_pallet_no_by_log_no_code,
  fetch_dressing_done_details_by_bundle_id,
} from '../../../../controllers/factory/dressing/dressing_done/dressing_issue_for_order.controller.js';
...
dressing_done_router.get(
  '/log-no-code-dropdown/:id',
  AuthMiddleware,
  fetch_all_log_no_code_by_item_name
);
dressing_done_router.get(
  '/pallet-no-dropdown/:log_no_code',
  AuthMiddleware,
  fetch_all_pallet_no_by_log_no_code
);
dressing_done_router.get(
