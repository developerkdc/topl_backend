...
import { create_dressing, fetch_all_dressing_done_items, fetch_all_dressing_done_items_by_other_details_id, edit_dressing_done_items, fetch_single_dressing_done_item, fetch_dressing_done_history } from '../../../../controllers/factory/dressing/dressing_done/dressing.done.controller.js';
...
dressing_done_router.post("/edit-dressing-done-items/:slicing_done_other_details_id", AuthMiddleware, edit_dressing_done_items);
