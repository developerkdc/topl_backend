...
router.post(
  '/add-expenseType-master',
  AuthMiddleware,
  RolesPermissions('expense_type_master', 'create'),
  AddExpenseTypeMaster
);
router.post(
  '/update-expenseType-master',
  AuthMiddleware,
  RolesPermissions('expense_type_master', 'edit'),
  UpdateExpenseTypeMaster
);
router.post(
  '/list-expenseType-master',
  AuthMiddleware,
  RolesPermissions('expense_type_master', 'view'),
  ListExpenseTypeMaster
);
