...
router.post("/add-grade-master", AuthMiddleware, RolesPermissions("grade_master", "create"), AddGradeMaster);
router.post("/update-grade-master", AuthMiddleware, RolesPermissions("grade_master", "edit"), UpdateGradeMaster);
router.post("/list-grade-master", AuthMiddleware, RolesPermissions("grade_master", "view"), ListGradeMaster);
