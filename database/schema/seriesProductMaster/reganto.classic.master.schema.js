...
const regantoClassicSchema = new mongoose.Schema(
    {
        default_item_name: {
            type: String,
            uppercase: true,
...
const regantoClassicModel = mongoose.model('reganto_classic', regantoClassicSchema);
export default regantoClassicModel;
