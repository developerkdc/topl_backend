...
export const customer_model = mongoose.model("customers", customerSchema, "customers")
export const customer_client_model = mongoose.model("customer_clients", customerClientSchema, "customer_clients")
