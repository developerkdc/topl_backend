...
crosscutting_done_schema.index({ issue_for_croscutting_id: -1, code: -1 }, { unique: true })

export const crosscutting_done_model = mongoose.model("crosscutting_done", crosscutting_done_schema);
