...
tapping_done_other_details_schema.index({ issue_for_tapping_item_id: -1 }, { unique: true })
export const tapping_done_other_details_model = mongoose.model("tapping_done_other_details", tapping_done_other_details_schema, "tapping_done_other_details");
...
export const tapping_done_items_details_model = mongoose.model("tapping_done_items_details", tapping_done_items_details_schema, "tapping_done_items_details");