...
plywood_resize_damage_schema.index({ issue_for_resizing_id: 1 }, { unique: true })

const plywood_resize_damage_model = mongoose.model('plywood_resize_damage_details', plywood_resize_damage_schema, 'plywood_resize_damage_details');
