...
const plywood_resizing_history_schema = new mongoose.Schema(
  {
    plywood_resizing_done_id: {
...
indexingFields.forEach((index) =>
  plywood_resizing_history_schema.index(...index)
);

const plywood_resizing_history_model = mongoose.model(
  'plywood_resizing_history_details',
  plywood_resizing_history_schema,
  'plywood_resizing_history_details'
);
