...
const bunito_done_details_schema = new mongoose.Schema(
  {
    sr_no: Number,
    issue_for_bunito_id: {
...
const indexed_fields = [[{ issue_for_bunito_id: 1 }], [{ sr_no: 1 }, { unique: true }]]
indexed_fields?.forEach((field) => bunito_done_details_schema.index(...field))


export const bunito_done_details_model = mongoose.model(
  'bunito_done_details',
  bunito_done_details_schema,
  'bunito_done_details'
);
