...
const issue_for_bunito_view_schema = new mongoose.Schema(
  {},
  { autoCreate: false, autoIndex: false, strict: false }
);
export const issue_for_bunito_view_model = mongoose.model(
  'issue_for_bunito_details_view',
  issue_for_bunito_view_schema,
  'issue_for_bunito_details_view'
);

(async function () {
  await issue_for_bunito_view_model.createCollection({
    viewOn: 'issued_for_bunito_details',
    pipeline: [
      {
        $sort: {
          updatedAt: -1,
