...
const issue_for_cnc_view_schema = new mongoose.Schema({}, { autoCreate: false, autoIndex: false, strict: false });
export const issue_for_cnc_view_model = mongoose.model('issue_for_cnc_details_view', issue_for_cnc_view_schema, 'issue_for_cnc_details_view');
