...
const process_done_details = new mongoose.Schema(
  {
    process_done_date: {
      type: Date,
    ...
    issue_for_smoking_dying_pallet_number: {
      ...
      required: [
        true,
        'Issues for smoking and dying pallet number is required',
      ],
    },
    item_name: {
      type: String,
    ...
    bundles: {
      type: [
        {
          ...
          character_id: {
            type: mongoose.Schema.Types.ObjectId,
            required: [
              validate_dressing_required_field,
              'Charcter ID is required',
            ],
          },
          character_name: {
            type: String,
      ...
      validate: {
        ...
        message: 'Bundle List is required',
      },
    },
    created_by: {
      type: mongoose.Schema.Types.ObjectId,
