...
const issues_for_pressing_schema = new mongoose.Schema(
  {
    order_id: {
    ...
    issued_from: {
      type: String,
      enum: {
        values: [issues_for_status.tapping],
        message: `Invalid type {{VALUE}} it must be one of the ${issues_for_status.tapping}`,
      },
      default: null,
    },
    is_pressing_done: {
...
export const issues_for_pressing_model = mongoose.model(
  'issues_for_pressings',
  issues_for_pressing_schema,
  'issues_for_pressings'
);
