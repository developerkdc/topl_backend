...
const issue_for_slicing_schema = new mongoose.Schema({
    ...
    issued_from: {
        ...
        enum: {
            values: [issues_for_status?.flitching, issues_for_status?.flitching_done],
...
export const issued_for_slicing_model = mongoose.model('issued_for_slicings', issue_for_slicing_schema, 'issued_for_slicings');
