...
issue_for_slicing_wastage_schema?.index({ issue_for_scliing_id: 1 }, { unique: true });
const issue_for_slicing_wastage_model = mongoose.model('issue_for_slicing_wastage', issue_for_slicing_wastage_schema, 'issue_for_slicing_wastage');
