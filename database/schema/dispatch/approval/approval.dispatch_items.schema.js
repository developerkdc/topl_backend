...
const approval_dispatch_items_schema = new mongoose.Schema(
  {
    ...
    approval_dispatch_item_id: {
      type: mongoose.Schema.Types.ObjectId,
      required: [true, "Approval Dispatch Item ID is required."]
    },
...
const approval_dispatch_items_model = mongoose.model(
  'approval_dispatch_items',
  approval_dispatch_items_schema,
  'approval_dispatch_items'
);
export default approval_dispatch_items_model;
