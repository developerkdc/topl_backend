...
const approval_packing_done_other_details_schema = new mongoose.Schema(
    {
        approval_packing_id: {
...
const approval_packing_done_items_schema = new mongoose.Schema(
    {
        ...
        packing_item_id: {
            type: mongoose.Schema.Types.ObjectId,
            required: [true, "Packing Item ID is required"]
        },
...
approval_packing_done_other_details_schema.add(approvalSchema)
const indexed_fields = [
    [{ packing_done_other_details_id: 1 }]
]

indexed_fields.forEach((field) => {
    approval_packing_done_items_schema.index(...field)
})
export const approval_packing_done_other_details_model = mongoose.model(
    'approval_packing_done_other_details',
    approval_packing_done_other_details_schema,
    'approval_packing_done_other_details'
);
export const approval_packing_done_items_model = mongoose.model(
    'approval_packing_done_items',
    approval_packing_done_items_schema,
    'approval_packing_done_items'
);
