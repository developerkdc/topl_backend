...
const log_inventory_items_details = mongoose.model("log_inventory_items_details",log_item_details_schema)
const log_inventory_invoice_details = mongoose.model("log_inventory_invoice_details",log_invoice_schema)
