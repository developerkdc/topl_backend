...
export const fetch_single_issue_of_dressing_item = catchAsync(async (req, res) => {
    const { id } = req.params;
    ...
    const response = new ApiResponse(StatusCodes.OK, "Data fetched successfully", result);
