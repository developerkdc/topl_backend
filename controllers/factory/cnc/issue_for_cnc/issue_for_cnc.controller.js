...
export const listing_issued_for_cnc = catchAsync(
    async (req, res, next) => {
        const {
            page = 1,
            limit = 10,
        ...
        console.log("listing_issued_for_cnc");
...
export const fetch_single_issue_for_cnc_item = catchAsync(async (req, res) => {
    ...
    const response = new ApiResponse(StatusCodes.OK, "CNC Details fetched successfully", result);
    return res.status(StatusCodes.OK).json(response)
});