...
export const listing_resizing_damage = catchAsync(async (req, res) => {
  const {
    page = 1,
    limit = 10,
    sortBy = 'updatedAt',
  ...
  const response = new ApiResponse(
    StatusCodes.OK,
    'Resizing Damage Data Fetched Successfully',
    {
      data: resizing_damage_list,
