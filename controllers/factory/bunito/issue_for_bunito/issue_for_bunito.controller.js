...
export const revert_issue_for_bunito = catchAsync(async (req, res) => {
    ...
    try {
        ...
        const issue_for_cnc_details = await issue_for_bunito_model.findById(id).lean();
        ...
        const delete_issue_for_cnc_document_result = await issue_for_bunito_model.deleteOne({ _id: issue_for_cnc_details?._id }, { session });
...
export const listing_issued_for_cnc = catchAsync(async (req, res, next) => {
    ...
    const issue_for_cnc =
        await issue_for_bunito_model.aggregate(listAggregate);
    ...
    const totalDocument =
        await issue_for_bunito_model.aggregate(totalAggregate);
...
export const fetch_single_issue_for_cnc_item = catchAsync(async (req, res) => {
    ...
    const result = await issue_for_bunito_model
        .findOne({ _id: id })
        .lean();
