    ...
    if (
      ...
      if (check_invoice_id) {
        ...
        if (
          ...
          throw new ApiError(
            'Failed to update flitch inventory invoice status', StatusCodes?.BAD_REQUEST
          );
        }
      }
      ...
      if (
        ...
        throw new ApiError('Failed to update flitch inventory item status', StatusCodes.BAD_REQUEST);
      }
    }
    if (
