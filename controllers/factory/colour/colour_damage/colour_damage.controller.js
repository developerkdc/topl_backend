...
export const listing_colour_damage = catchAsync(
    async (req, res) => {
        const {
            page = 1,
            limit = 10,
        ...
        const response = new ApiResponse(
            StatusCodes.OK,
            'Colour Damage Data Fetched Successfully',
            {
                data: colour_damage_list,
...
export const add_colour_damage = catchAsync(async (req, res) => {
    ...
    try {
        ...
        const add_colour_damage_data_result=[];
        const response = new ApiResponse(StatusCodes.CREATED, "Colour Damage Created Successfully", add_colour_damage_data_result);
