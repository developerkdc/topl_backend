...
export const fetch_all_series_order_items = catchAsync(async (req, res, next) => {
    const {
        page = 1,
        sortBy = 'updatedAt',
        sort = 'desc',
    ...
    const result = await series_product_order_item_details_model?.aggregate(list_aggregate);
