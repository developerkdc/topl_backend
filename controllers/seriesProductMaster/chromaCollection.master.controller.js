...
export const addChromaCollection = catchAsync(async (req, res, next) => {
    ...
    const newChromaCollection = new chromaCollectionModel(chromaCollectionDetails);
...
export const updateChromaCollectionDetails = catchAsync(async (req, res, next) => {
    const { id } = req.params;
    const reqBody = req.body;
    const authUserDetails = req.userDetails;

    if (!id) {
        return next(new ApiError("ChromaCollection id is missing", StatusCodes.NOT_FOUND))
    }
    ...
    const updateResponse = await chromaCollectionModel.updateOne({_id:id}, {
        $set: updatedDetails,
...
export const fetchChromaCollectionList = catchAsync(async (req, res, next) => {
    ...
    const chromaCollectionData = await chromaCollectionModel.aggregate(listAggregate);
...
export const fetchSingleChromaCollection = catchAsync(async (req, res, next) => {
    const { id } = req.params
    ...
    const chromaCollectionData = await chromaCollectionModel.aggregate(aggregate);
