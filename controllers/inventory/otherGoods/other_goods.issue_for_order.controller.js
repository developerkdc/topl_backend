...
export const fetch_all_other_goods_inward_sr_no_by_order_item_name = catchAsync(
  async (req, res) => {
    const { id } = req.params;
...
export const fetch_all_other_goods_sr_no_by_inward_sr_no = catchAsync(
  async (req, res) => {
    ...
    const result = await othergoods_inventory_items_details
      .aggregate(pipeline)
