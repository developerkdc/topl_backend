...
import { flitch_inventory_invoice_details, flitch_inventory_items_details, flitch_inventory_items_view_modal, } from "../../../database/schema/inventory/Flitch/flitch.schema.js";
...
export const listing_flitch_inventory = catchAsync(async (req, res, next) => {
    ...
    const List_flitch_inventory_details = await flitch_inventory_items_view_modal.aggregate(aggregate_stage);
...
export const add_flitch_inventory = catchAsync(async (req, res, next) => {
    ...
    try {
        ...
        const latest_inward_sr_no = inward_sr_no?.length > 0 && inward_sr_no?.[0]?.latest_inward_sr_no ? inward_sr_no?.[0]?.latest_inward_sr_no + 1 : 1;
...
export const edit_flitch_invoice_inventory = catchAsync(async (req, res, next) => {
