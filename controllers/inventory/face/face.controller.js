...
export const listing_face_inventory = catchAsync(async (req, res, next) => {
  ...
  const List_face_inventory_details = await face_inventory_items_view_modal.aggregate(aggregate_stage);
...
export const add_face_inventory = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    const add_items_details = await face_inventory_items_details.insertMany(items_details, {
      session,
    });
...
export const add_single_face_item_inventory = catchAsync(async (req, res, next) => {
...
export const edit_face_invoice_inventory = catchAsync(async (req, res, next) => {
...
export const edit_face_item_invoice_inventory = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    const update_invoice_details = await face_inventory_invoice_details.updateOne(
      { _id: invoice_id },
      {
        $set: {
          ...invoice_details,
